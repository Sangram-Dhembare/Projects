...
<head>
	...
	<!-- //web font -->
	<script src="https://cdn.tiny.cloud/1/jqxhb9ywuynhef2ilecli9uhy6raybvn7fqo6vf1kac5bqar/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
				...
				<div class="header-left-bottom">
					<form action="#" method="post">	
						<div class="icon1"> 
							...
							Task Tittle :<input type="text" placeholder="Enter Title" name="task_name" required=""/>
						</div>	

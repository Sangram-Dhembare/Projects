...
<div class="w3layouts-main"> 
    <div class="bg-layer">
        <h1 style="color: white;text-shadow: 1px 1px 8px black;">Sentinel</h1>
            ...
            <div class="header-left-bottom">
                <form action="#" method="post">     
                    ...
                    <div class="links">
                        ...
                        <div class="links">
                        <p class="right"><a href="registration.php">Register as Admin</a></p>
                        <div class="clear"></div>
                    </div>
                </form> 
            </div>
...
<?php
     ...
     if(isset($_POST['submit']))
        {     
               ...
               //sql Query= "SELECT * FROM user WHERE user_email = '".$email."' AND  user_password = '".$password."' AND  user_status = '1'";
